...
const GroupTwoHome = ({ User }) => {
  ...
  return (
    <div id="HomeContainer">
      ...
      <div className="GroupHome" id="GroupHome_G02">
        <div className="GroupHome_Main">
          <div className="GroupHome_MainText">
            <div className="GroupHome_Cover" />
            <h1 className="GroupHome_GroupNumber">Group.02</h1>
            <h1 className="GroupHome_GroupName">Go back</h1>
          ...
          <div className="GroupHome_Image" id="GroupHomeImage_G02"></div>
        </div>
