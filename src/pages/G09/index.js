...
const GroupNineHome = ({ User }) => {
  ...
  const PlayGame = (e) => {
    ...
    $("#Iframe").attr("src", "./Project/G09/index.html");
  ...
  return (
    <div id="HomeContainer">
      ...
      <div className="GroupHome" id="GroupHome_G09">
        <div className="GroupHome_Main">
          <div className="GroupHome_MainText">
            <div className="GroupHome_Cover" />
            <h1 className="GroupHome_GroupNumber">Group.09</h1>
            <h1 className="GroupHome_GroupName">ANSON</h1>
            <h3 className="GroupHome_GroupMember">
              陳品坊、孫葳麟、洪子晴、吳品萱
            </h3>
            <Button
              id="GroupHome_PlayButton"
              href="https://youtu.be/HVpSxFcqhmI"
              variant="contained"
          ...
          <div className="GroupHome_Image" id="GroupHomeImage_G09"></div>
        </div>
