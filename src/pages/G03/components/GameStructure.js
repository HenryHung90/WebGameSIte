...
const GameStructure = () => {
  ...
  const Content = [
    ["./Project/G03/img/Structure_1.png", "./Project/G03/img/Structure_2.png"],
    [
      "./Project/G03/img/Structure_3.png",
      "./Project/G03/img/Structure_4.png",
      "./Project/G03/img/Structure_5.png",
    ],
  ];
