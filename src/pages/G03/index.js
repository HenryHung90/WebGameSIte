...
const GroupThreeHome = ({ User }) => {
  ...
  const PlayGame = (e) => {
    ...
    $("#Iframe").attr("src", "./Project/G03/Scene0.html");
  ...
  return (
    <div id="HomeContainer">
      ...
      <div className="GroupHome" id="GroupHome_G03">
        <div className="GroupHome_Main">
          <div className="GroupHome_MainText">
            <div className="GroupHome_Cover" />
            <h1 className="GroupHome_GroupNumber">Group.03</h1>
            <h1 className="GroupHome_GroupName">快點揪出來</h1>
          ...
          <div className="GroupHome_Image" id="GroupHomeImage_G03"></div>
        </div>
