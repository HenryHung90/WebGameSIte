...
const GroupElevenHome = ({ User }) => {
  ...
  const PlayGame = (e) => {
    ...
    $("#Iframe").attr("src", "./Project/G11/index.html");
  ...
  return (
    <div id="HomeContainer">
      ...
      <div className="GroupHome" id="GroupHome_G11">
        <div className="GroupHome_Main">
          <div className="GroupHome_MainText">
            <div className="GroupHome_Cover" />
            <h1 className="GroupHome_GroupNumber">Group.11</h1>
            <h1 className="GroupHome_GroupName">霍爾斯之旅</h1>
            <h3 className="GroupHome_GroupMember">
              方國軒、李如喬、蕭鈺騰、李曉柔、高琮凱
            </h3>
            <Button
              id="GroupHome_PlayButton"
              href="https://youtu.be/TwXgtwoY1Vc"
              variant="contained"
          ...
          <div className="GroupHome_Image" id="GroupHomeImage_G11"></div>
        </div>
...
export default GroupElevenHome;
