...
const GroupFiveHome = ({ User }) => {
  ...
  const PlayGame = (e) => {
    ...
    $("#Iframe").attr("src", "./Project/G05/index.html");
  ...
  return (
    <div id="HomeContainer">
      ...
      <div className="GroupHome" id="GroupHome_G05">
        <div className="GroupHome_Main">
          <div className="GroupHome_MainText">
            <div className="GroupHome_Cover" />
            <h1 className="GroupHome_GroupNumber">Group.05</h1>
            <h1 className="GroupHome_GroupName">黴菌軍團</h1>
            <h3 className="GroupHome_GroupMember">
              詹侑庭、趙蔆瑄、高詠涵、黃巧鈴
            </h3>
            <Button
              id="GroupHome_PlayButton"
              href="https://youtu.be/UEVbmAIfxJc"
              variant="contained"
          ...
          <div className="GroupHome_Image" id="GroupHomeImage_G05"></div>
        </div>
