...
const GroupTenHome = ({ User }) => {
  ...
  const PlayGame = (e) => {
    ...
    $("#Iframe").attr("src", "./Project/G10/index.html");
  ...
  return (
    <div id="HomeContainer">
      ...
      <div className="GroupHome" id="GroupHome_G10">
        <div className="GroupHome_Main">
          <div className="GroupHome_MainText">
            <div className="GroupHome_Cover" />
            <h1 className="GroupHome_GroupNumber">Group.10</h1>
            <h1 className="GroupHome_GroupName">咻蛋幾勒</h1>
            <h3 className="GroupHome_GroupMember">
              范芯語、林語柔、蔡宇宸、賈承恩
            </h3>
            <Button
              id="GroupHome_PlayButton"
              href="https://youtu.be/SylgR4SM8Bw"
              variant="contained"
          ...
          <div className="GroupHome_Image" id="GroupHomeImage_G10"></div>
        </div>
