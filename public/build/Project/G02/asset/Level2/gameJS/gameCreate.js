function create() {
  ...
  this.anims.create({
    key: "jumpLeft",
    frames: this.anims.generateFrameNumbers("player-jump-left", {
      start: 0,
      end: 4,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    key: "jumpRight",
    frames: this.anims.generateFrameNumbers("player-jump-right", {
      start: 0,
      end: 4,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    key: "slideLeft",
    frames: this.anims.generateFrameNumbers("player-slide-left", {
      start: 0,
      end: 0,
    }),
    frameRate: 10,
  ...
  this.anims.create({
    key: "slideRight",
    frames: this.anims.generateFrameNumbers("player-slide-right", {
      start: 0,
      end: 0,
    }),
    frameRate: 10,
  ...
  this.anims.create({
    key: "deadLeft",
    frames: this.anims.generateFrameNumbers("player-dead-left", {
      start: 0,
      end: 3,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    key: "deadRight",
    frames: this.anims.generateFrameNumbers("player-dead-right", {
      start: 0,
      end: 3,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    key: "climb",
    frames: this.anims.generateFrameNumbers("player-climb", {
      start: 0,
      end: 5,
    }),
    frameRate: 10,
  ...
  this.anims.create({
    key: "MrunLeft",
    frames: this.anims.generateFrameNumbers("M-player-run-left", {
      start: 0,
      end: 4,
    }),
    frameRate: 10,
  ...
  this.anims.create({
    key: "MrunRight",
    frames: this.anims.generateFrameNumbers("M-player-run-right", {
      start: 0,
      end: 4,
    }),
    frameRate: 10,
  ...
  this.anims.create({
    key: "MjumpLeft",
    frames: this.anims.generateFrameNumbers("M-player-jump-left", {
      start: 0,
      end: 4,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    key: "MjumpRight",
    frames: this.anims.generateFrameNumbers("M-player-jump-right", {
      start: 0,
      end: 4,
    }),
    frameRate: 5,
  ...
  this.anims.create({
    key: "MslideLeft",
    frames: this.anims.generateFrameNumbers("M-player-slide-left", {
      start: 0,
      end: 0,
    }),
    frameRate: 10,
  ...
  this.anims.create({
    key: "MslideRight",
    frames: this.anims.generateFrameNumbers("M-player-slide-right", {
      start: 0,
      end: 0,
    }),
    frameRate: 10,
  ...
  this.anims.create({
    key: "Mclimb",
    frames: this.anims.generateFrameNumbers("M-player-climb", {
      start: 0,
      end: 5,
    }),
    frameRate: 5,
  ...
  overCage2 = this.physics.add.overlap(
    player,
    cageTrigger2,
    getCage2.bind(this)
  );
  overPoison = this.physics.add.overlap(player, poisonTrigger, GameOver);
  overDeadBody = this.physics.add.overlap(
    player,
    deadBody,
    getDeadBody.bind(this)
  );
  overArrowRight = this.physics.add.overlap(
    player,
    arrowTrigger,
    getArrowRight.bind(this)
  );
  //Restart the game
